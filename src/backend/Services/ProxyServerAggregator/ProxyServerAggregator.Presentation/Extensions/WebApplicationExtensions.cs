...
public static class WebApplicationExtensions
{
    public static WebApplication UseOpenApi(this WebApplication app)
    {
        ...
        {
            options.SwaggerEndpoint("/openapi/v1/openapi.yaml", "Proxy Server Aggregator API");
        
            options.RoutePrefix   = "swagger";
            options.DocumentTitle = "ProxyServerAggregator";
        ...
        {
            options.AddDocument("v1", "Proxy Server Aggregator API", "/openapi/v1/openapi.yaml");
        
            options.Title               = "Proxy Server Aggregator API";
        ...
        {
            options.DocumentTitle  = "Proxy Server Aggregator API";
