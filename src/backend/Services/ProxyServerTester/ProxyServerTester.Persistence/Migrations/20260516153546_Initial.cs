...
namespace ProxyServerTester.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "proxy_server_test_stored_tasks",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_proxy_server_test_stored_tasks", x => x.id);
                    table.ForeignKey(
                        name: "fk_proxy_server_test_stored_tasks_proxy_server_test_requests_r",
                        column: x => x.request_id,
                        principalTable: "proxy_server_test_requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_attempt_deadline",
                table: "proxy_server_test_stored_tasks",
                column: "attempt_deadline");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_attempts",
                table: "proxy_server_test_stored_tasks",
                column: "attempts");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_attempts_remaining",
                table: "proxy_server_test_stored_tasks",
                column: "attempts_remaining");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_created_at",
                table: "proxy_server_test_stored_tasks",
                column: "created_at");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_deadline",
                table: "proxy_server_test_stored_tasks",
                column: "deadline");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_entity_state",
                table: "proxy_server_test_stored_tasks",
                column: "entity_state");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_request_id",
                table: "proxy_server_test_stored_tasks",
                column: "request_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_state",
                table: "proxy_server_test_stored_tasks",
                column: "state");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_state_attempt_deadline_attem",
                table: "proxy_server_test_stored_tasks",
                columns: new[] { "state", "attempt_deadline", "attempts_remaining", "deadline" });

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_updated_at",
                table: "proxy_server_test_stored_tasks",
                column: "updated_at");

            migrationBuilder.CreateIndex(
                name: "ix_proxy_server_test_stored_tasks_worker_id",
                table: "proxy_server_test_stored_tasks",
                column: "worker_id");
